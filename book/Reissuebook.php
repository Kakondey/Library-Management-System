   ...
   <body background = "../assets/bluebackground.jpg">
     ...
     <table cellpadding="8" cellspacing="0" border="1" style="margin: 150px;">
       ...
       <?php
         ...
         $sql = "SELECT * FROM reissue_finelist WHERE borrowstatus='pending' AND reissueStatus='not reissued'";
         $query = mysqli_query($conn,$sql);
       ...
       ?>
           ...
           <tr>
             ...
             <td>
                 <a href="Reissuebook.php?reissue=1&bcode=<?php echo $row->bcode; ?>&uid=<?php echo $row->uid; ?>"><input type="Submit" name="reissue" value="REISSUE"></a>
             </td>
           </tr>
