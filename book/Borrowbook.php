    ...
    if($selectbook)
    {
      foreach ($selectbook as $value)
      {
            ...
            if($returndate < $borrowdate)
            {
              $error = true;
              echo "<script>
              alert('Please mark dates after today(i.e 7 days)');
              window.location.href='Borrowbook.php';
              </script>
              ";
            }
    ...
    <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post">
      ...
      <div>
        ...
        <table cellpadding="8" cellspacing="0" border="1" style="margin: 150px;">
          ...
          <input type="submit" name="Borrow-btn" value="Borrow" class="btnborrow" style="vertical-align: bottom; display: inline-block; ">
        </center>
      </div>
